...
class RandomExplorerActions(RandomExplorerServices):
    ...
    def __init__(self):
        ...
        print("new RandomExplorerActions explorer_actions.py")

        with open(logFile, "a") as file:
            file.write("New RandomExplorerActions\n")
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            # rospy.loginfo("2 New Goal...")
            # rospy.loginfo("------------")

            # with open("/home/chall2/src/turtlebot_explorer/nodes/outFile.txt", "a") as file:
            # with open(logFile, "a") as file:
                # print("Started a new robot message")
                # file.write("2 New Goal...\n")
